...
export default function ContactPage() {
  ...
  return (
    <>
      <Head>
        <title>Contacto - Agenda tu Diagnóstico de Precisión - Nexoria Toluca y CDMX</title>
        <meta name="description" content="¿Listo para llevar tu empresa al siguiente nivel en Toluca Estado de México y Ciudad de México? Agenda tu diagnóstico de precisión y descubre cómo podemos ayudarte a crecer de manera rentable y ordenada." />
        <meta name="keywords" content="contacto Nexoria Toluca, consultora legal en Toluca, diagnóstico empresarial CDMX, consulta gratuita Edomex, transformación empresarial Ciudad de México" />
      </Head>
      ...
      <div className="w-full max-w-2xl mx-auto px-4">
        <div className="bg-gray-900 shadow-2xl rounded-3xl p-10 border border-nexoria-orange/30">
          <h1 className="text-4xl font-bold text-center mb-8 text-nexoria-orange">¿Listo para llevar tu empresa al siguiente nivel?</h1>
          <div className="mb-8 text-center">
            <p className="text-lg text-gray-300">
              Agenda tu diagnóstico de precisión y descubre cómo podemos ayudarte a crecer de manera rentable, ordenada y con total seguridad legal. Completa el formulario y nos pondremos en contacto contigo a la brevedad.
            </p>
          </div>
          {success && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="mt-1 block w-full rounded-lg border border-nexoria-orange bg-gray-800 text-nexoria-white placeholder-gray-400 shadow-sm focus:border-nexoria-orange focus:ring-nexoria-orange text-base px-4 py-3"
                placeholder="Cuéntanos sobre tu empresa y qué desafíos enfrentas"
              />
            </div>
            <div>
              <button
              ...
              >
                {loading ? 'Enviando...' : 'Agendar diagnóstico de precisión'}
              </button>
            </div>
          </form>
